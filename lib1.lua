...
local themes = {
	index = {'Dark', 'Amethyst'},
	Amethyst = {
    ['Shadow'] = Color3.fromRGB(0, 1, 46),           -- ปรับเป็นสีเข้มตาม Accent / Tab Shadow
    ['Background'] = Color3.fromRGB(35, 35, 35),     -- PlaceholderText / สีเทาอ่อน
    ['Page'] = Color3.fromRGB(0, 1, 46),             -- Main / Accent
    ['Main'] = Color3.fromRGB(0, 1, 46),             -- Main / Accent
    ['Text & Icon'] = Color3.fromRGB(255, 255, 255), -- Outline / Text
    ['Function'] = {
        ['Toggle'] = {
            ['Background'] = Color3.fromRGB(35, 35, 35), -- Background
            ['True'] = {
                ['Toggle Background'] = Color3.fromRGB(0, 1, 46), -- Accent
                ['Toggle Value'] = Color3.fromRGB(0, 1, 46),      -- Accent
            },
            ['False'] = {
                ['Toggle Background'] = Color3.fromRGB(60, 60, 60), -- สีเทาเข้ม
                ['Toggle Value'] = Color3.fromRGB(90, 90, 90),      -- สีเทาเข้ม
            }
        },
        ['Label'] = {
        ...
        ['Dropdown'] = {
            ['Background'] = Color3.fromRGB(35, 35, 35),
            ['Value Background'] = Color3.fromRGB(0, 1, 46),
            ['Value Stroke'] = Color3.fromRGB(255, 255, 255),
            ['Dropdown Select'] = {
                ['Background'] = Color3.fromRGB(0, 1, 46),
                ['Search'] = Color3.fromRGB(35, 35, 35),
                ['Item Background'] = Color3.fromRGB(60, 60, 60),
            }
        },
        ['Slider'] = {
            ['Background'] = Color3.fromRGB(35, 35, 35),
            ['Value Background'] = Color3.fromRGB(0, 1, 46),
            ['Value Stroke'] = Color3.fromRGB(255, 255, 255),
            ['Slider Bar'] = Color3.fromRGB(0, 1, 46),
            ['Slider Bar Value'] = Color3.fromRGB(0, 1, 46),
        ...
        ['Keybind'] = {
            ...
            ['Value Stroke'] = Color3.fromRGB(255, 255, 255),
            ['True'] = {
                ['Toggle Background'] = Color3.fromRGB(0, 1, 46),
                ['Toggle Value'] = Color3.fromRGB(0, 1, 46),
            },
            ['False'] = {
                ['Toggle Background'] = Color3.fromRGB(60, 60, 60),
                ['Toggle Value'] = Color3.fromRGB(90, 90, 90),
            }
        },
        ['Color Picker'] = {
            ['Background'] = Color3.fromRGB(35, 35, 35),
